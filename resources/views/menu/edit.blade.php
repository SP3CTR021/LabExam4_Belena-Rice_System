                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('menus.update', $menu) }}">
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="price_per_kilo" name="price_per_kilo" type="number" step="0.01" class="mt-1 block w-full" value="{{ old('price_per_kilo', $menu->price_per_kilo) }}" required />
                            <x-input-error :messages="$errors->get('price_per_kilo')" class="mt-2" />
                        </div>

                        <div class="mt-4">
                            <x-input-label for="stock" :value="__('Stock')" />
                            <x-text-input id="stock" name="stock" type="number" min="0" class="mt-1 block w-full" value="{{ old('stock', $menu->stock) }}" required />
